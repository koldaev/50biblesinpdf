...
--
-- Table structure for table `trstrings`
--

DROP TABLE IF EXISTS `trstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `trstrings` (
...
--
-- Dumping data for table `trstrings`
--

LOCK TABLES `trstrings` WRITE;
/*!40000 ALTER TABLE `trstrings` DISABLE KEYS */;
INSERT INTO `trstrings` VALUES (1,'Kutsal Kitap','Yeni Antlaşma','Eski Antlaşma','Bölüm','Mezmur','ayet','Ara');
/*!40000 ALTER TABLE `trstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:58:03
