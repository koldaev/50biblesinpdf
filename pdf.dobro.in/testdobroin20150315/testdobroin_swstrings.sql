...
--
-- Table structure for table `swstrings`
--

DROP TABLE IF EXISTS `swstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `swstrings` (
...
--
-- Dumping data for table `swstrings`
--

LOCK TABLES `swstrings` WRITE;
/*!40000 ALTER TABLE `swstrings` DISABLE KEYS */;
INSERT INTO `swstrings` VALUES (1,'Biblia Takatifu','Agano la Kale','Agano Jipya','Sura ya','Zaburi','Shairi','kupata');
/*!40000 ALTER TABLE `swstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:03:34
