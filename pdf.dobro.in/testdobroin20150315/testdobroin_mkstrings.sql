...
--
-- Table structure for table `mkstrings`
--

DROP TABLE IF EXISTS `mkstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mkstrings` (
...
--
-- Dumping data for table `mkstrings`
--

LOCK TABLES `mkstrings` WRITE;
/*!40000 ALTER TABLE `mkstrings` DISABLE KEYS */;
INSERT INTO `mkstrings` VALUES (1,'Библија','Стар Завет','Нов Завет','Глава','Псалм','стих','Најди');
/*!40000 ALTER TABLE `mkstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:55:37
