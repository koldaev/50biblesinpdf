...
--
-- Table structure for table `sqstrings`
--

DROP TABLE IF EXISTS `sqstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sqstrings` (
...
--
-- Dumping data for table `sqstrings`
--

LOCK TABLES `sqstrings` WRITE;
/*!40000 ALTER TABLE `sqstrings` DISABLE KEYS */;
INSERT INTO `sqstrings` VALUES (1,'Bibla e Shenjtë','Dhjata e Vjetër','Dhjata e Re','Kapitull','Psalm','Poemë','Gjej');
/*!40000 ALTER TABLE `sqstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:04:16
