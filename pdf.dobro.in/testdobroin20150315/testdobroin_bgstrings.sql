...
--
-- Table structure for table `bgstrings`
--

DROP TABLE IF EXISTS `bgstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bgstrings` (
...
--
-- Dumping data for table `bgstrings`
--

LOCK TABLES `bgstrings` WRITE;
/*!40000 ALTER TABLE `bgstrings` DISABLE KEYS */;
INSERT INTO `bgstrings` VALUES (1,'Библия','СТАР ЗАВЕТ','НОВ ЗАВЕТ','Глава','Псалм','стих','Намирам');
/*!40000 ALTER TABLE `bgstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:00:50
