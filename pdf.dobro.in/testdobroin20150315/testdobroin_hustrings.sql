...
--
-- Table structure for table `hustrings`
--

DROP TABLE IF EXISTS `hustrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hustrings` (
...
--
-- Dumping data for table `hustrings`
--

LOCK TABLES `hustrings` WRITE;
/*!40000 ALTER TABLE `hustrings` DISABLE KEYS */;
INSERT INTO `hustrings` VALUES (1,'Szent Biblia','Ószövetség','Újszövetség','fejezet','Zsoltár','Vers','talál');
/*!40000 ALTER TABLE `hustrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:24
