...
--
-- Table structure for table `hinstrings`
--

DROP TABLE IF EXISTS `hinstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hinstrings` (
...
--
-- Dumping data for table `hinstrings`
--

LOCK TABLES `hinstrings` WRITE;
/*!40000 ALTER TABLE `hinstrings` DISABLE KEYS */;
INSERT INTO `hinstrings` VALUES (1,'पवित्र बाइबिल','ओल्ड टैस्टमैंट','नई टैस्टमैंट','अध्याय','भजन','कविता','खोज');
/*!40000 ALTER TABLE `hinstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:00:31
