...
--
-- Table structure for table `plstrings`
--

DROP TABLE IF EXISTS `plstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `plstrings` (
...
--
-- Dumping data for table `plstrings`
--

LOCK TABLES `plstrings` WRITE;
/*!40000 ALTER TABLE `plstrings` DISABLE KEYS */;
INSERT INTO `plstrings` VALUES (1,'Biblia, Pismo Święte','Stary Testament','Nowy Testament','Rozdział','Psalm','wiersz','Szukaj');
/*!40000 ALTER TABLE `plstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:39
