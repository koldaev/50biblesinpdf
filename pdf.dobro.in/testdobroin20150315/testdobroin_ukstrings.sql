...
--
-- Table structure for table `ukstrings`
--

DROP TABLE IF EXISTS `ukstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ukstrings` (
...
--
-- Dumping data for table `ukstrings`
--

LOCK TABLES `ukstrings` WRITE;
/*!40000 ALTER TABLE `ukstrings` DISABLE KEYS */;
INSERT INTO `ukstrings` VALUES (1,'Біблія','Старий Заповіт','Новий Заповіт','Глава','Псалом','вірш','Знайти');
/*!40000 ALTER TABLE `ukstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:53:57
