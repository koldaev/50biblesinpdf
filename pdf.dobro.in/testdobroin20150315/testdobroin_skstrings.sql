...
--
-- Table structure for table `skstrings`
--

DROP TABLE IF EXISTS `skstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `skstrings` (
...
--
-- Dumping data for table `skstrings`
--

LOCK TABLES `skstrings` WRITE;
/*!40000 ALTER TABLE `skstrings` DISABLE KEYS */;
INSERT INTO `skstrings` VALUES (1,'Biblia','Stará Zmluva','Nová Zmluva','Kapitola','Žalm','verš','Nájsť');
/*!40000 ALTER TABLE `skstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:57:00
