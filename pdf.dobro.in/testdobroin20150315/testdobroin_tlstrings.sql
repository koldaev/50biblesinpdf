...
--
-- Table structure for table `tlstrings`
--

DROP TABLE IF EXISTS `tlstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tlstrings` (
...
--
-- Dumping data for table `tlstrings`
--

LOCK TABLES `tlstrings` WRITE;
/*!40000 ALTER TABLE `tlstrings` DISABLE KEYS */;
INSERT INTO `tlstrings` VALUES (1,'Bibliya','Lumang Tipan','Bagong Tipan','Kabanata','Mga Awit','Tula','Hanapin');
/*!40000 ALTER TABLE `tlstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:30
