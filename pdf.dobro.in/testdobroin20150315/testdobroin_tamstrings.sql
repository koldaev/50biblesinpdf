...
--
-- Table structure for table `tamstrings`
--

DROP TABLE IF EXISTS `tamstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tamstrings` (
...
--
-- Dumping data for table `tamstrings`
--

LOCK TABLES `tamstrings` WRITE;
/*!40000 ALTER TABLE `tamstrings` DISABLE KEYS */;
INSERT INTO `tamstrings` VALUES (1,'வேதாகமம்','பழைய ஏற்பாடு','புதிய ஏற்பாடு','அத்தியாயம்','கடவுள் துதி','கவிதை','தேடு');
/*!40000 ALTER TABLE `tamstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:57:17
