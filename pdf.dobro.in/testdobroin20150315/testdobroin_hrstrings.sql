...
--
-- Table structure for table `hrstrings`
--

DROP TABLE IF EXISTS `hrstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hrstrings` (
...
--
-- Dumping data for table `hrstrings`
--

LOCK TABLES `hrstrings` WRITE;
/*!40000 ALTER TABLE `hrstrings` DISABLE KEYS */;
INSERT INTO `hrstrings` VALUES (1,'Biblija','Stari zavjet','Novi zavjet','Poglavlje','Psalm','Pjesma','Pronađi');
/*!40000 ALTER TABLE `hrstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:59:50
