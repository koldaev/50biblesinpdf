...
--
-- Table structure for table `ptstrings`
--

DROP TABLE IF EXISTS `ptstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ptstrings` (
...
--
-- Dumping data for table `ptstrings`
--

LOCK TABLES `ptstrings` WRITE;
/*!40000 ALTER TABLE `ptstrings` DISABLE KEYS */;
INSERT INTO `ptstrings` VALUES (1,'Bíblia','Velho Testamento','Novo Testamento','Cabeça','Salmo','verso','Encontrar');
/*!40000 ALTER TABLE `ptstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:04:44
