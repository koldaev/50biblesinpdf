...
--
-- Table structure for table `dastrings`
--

DROP TABLE IF EXISTS `dastrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dastrings` (
...
--
-- Dumping data for table `dastrings`
--

LOCK TABLES `dastrings` WRITE;
/*!40000 ALTER TABLE `dastrings` DISABLE KEYS */;
INSERT INTO `dastrings` VALUES (1,'Bibelen','Det Gamle Testamente','Det Nye Testamente','Kapitel','salme','digt','finde');
/*!40000 ALTER TABLE `dastrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:00
