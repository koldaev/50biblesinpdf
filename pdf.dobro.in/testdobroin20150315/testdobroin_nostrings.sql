...
--
-- Table structure for table `nostrings`
--

DROP TABLE IF EXISTS `nostrings`;
...
--
-- Dumping data for table `nostrings`
--

LOCK TABLES `nostrings` WRITE;
/*!40000 ALTER TABLE `nostrings` DISABLE KEYS */;
INSERT INTO `nostrings` VALUES (1,'Bibelen','Det gamle testamentet','Det nye testamentet','Kapittel','Salme','Dikt','finne');
/*!40000 ALTER TABLE `nostrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:57:03
