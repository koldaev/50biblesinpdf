...
--
-- Table structure for table `destrings`
--

DROP TABLE IF EXISTS `destrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `destrings` (
...
--
-- Dumping data for table `destrings`
--

LOCK TABLES `destrings` WRITE;
/*!40000 ALTER TABLE `destrings` DISABLE KEYS */;
INSERT INTO `destrings` VALUES (1,'Bibel','Neues Testament','Altes Testament','kapitel','Psalmen','Vers','Finden');
/*!40000 ALTER TABLE `destrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:04:25
