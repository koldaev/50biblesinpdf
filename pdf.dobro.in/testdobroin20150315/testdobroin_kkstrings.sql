...
--
-- Table structure for table `kkstrings`
--

DROP TABLE IF EXISTS `kkstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kkstrings` (
...
--
-- Dumping data for table `kkstrings`
--

LOCK TABLES `kkstrings` WRITE;
/*!40000 ALTER TABLE `kkstrings` DISABLE KEYS */;
INSERT INTO `kkstrings` VALUES (1,'Киелі Кітап','Көне келісім','Жаңа келісім','Тарау','діни жыр','тынымдады','іздеу');
/*!40000 ALTER TABLE `kkstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:00:44
