...
--
-- Table structure for table `lvstrings`
--

DROP TABLE IF EXISTS `lvstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lvstrings` (
...
--
-- Dumping data for table `lvstrings`
--

LOCK TABLES `lvstrings` WRITE;
/*!40000 ALTER TABLE `lvstrings` DISABLE KEYS */;
INSERT INTO `lvstrings` VALUES (1,'Bībele','Vecā derība','Jaunā derība','Nodaļa','Psalms','Dzejolis','Meklēt');
/*!40000 ALTER TABLE `lvstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:06:38
