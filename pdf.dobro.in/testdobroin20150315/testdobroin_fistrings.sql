...
--
-- Table structure for table `fistrings`
--

DROP TABLE IF EXISTS `fistrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fistrings` (
...
--
-- Dumping data for table `fistrings`
--

LOCK TABLES `fistrings` WRITE;
/*!40000 ALTER TABLE `fistrings` DISABLE KEYS */;
INSERT INTO `fistrings` VALUES (1,'Raamattu','Vanha Testamentti','Uusi Testamentti','Luku','Psalmi','Runo','haku');
/*!40000 ALTER TABLE `fistrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:03:31
