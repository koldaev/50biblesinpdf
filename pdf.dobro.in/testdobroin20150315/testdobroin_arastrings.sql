...
--
-- Table structure for table `arastrings`
--

DROP TABLE IF EXISTS `arastrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `arastrings` (
...
--
-- Dumping data for table `arastrings`
--

LOCK TABLES `arastrings` WRITE;
/*!40000 ALTER TABLE `arastrings` DISABLE KEYS */;
INSERT INTO `arastrings` VALUES (1,'الكتاب المقدس','العهد القديم','العهد الجديد','رئيس','مزمور','آية','اكتشاف');
/*!40000 ALTER TABLE `arastrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:58:18
