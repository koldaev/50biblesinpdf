...
--
-- Table structure for table `vistrings`
--

DROP TABLE IF EXISTS `vistrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vistrings` (
...
--
-- Dumping data for table `vistrings`
--

LOCK TABLES `vistrings` WRITE;
/*!40000 ALTER TABLE `vistrings` DISABLE KEYS */;
INSERT INTO `vistrings` VALUES (1,'Kinh Thánh','Kinh thánh Cựu ước','Tân Ước','Chương','Thánh thi','Bài thơ','Tìm');
/*!40000 ALTER TABLE `vistrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:33
