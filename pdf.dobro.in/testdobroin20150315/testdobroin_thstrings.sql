...
--
-- Table structure for table `thstrings`
--

DROP TABLE IF EXISTS `thstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `thstrings` (
...
--
-- Dumping data for table `thstrings`
--

LOCK TABLES `thstrings` WRITE;
/*!40000 ALTER TABLE `thstrings` DISABLE KEYS */;
INSERT INTO `thstrings` VALUES (1,'คัมภีร์ไบเบิล','พันธสัญญาเดิม','พันธสัญญาใหม่','บทที่','บทสวด','บทกวี','หา');
/*!40000 ALTER TABLE `thstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:59:30
