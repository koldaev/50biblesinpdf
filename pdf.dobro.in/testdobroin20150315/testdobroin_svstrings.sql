...
--
-- Table structure for table `svstrings`
--

DROP TABLE IF EXISTS `svstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `svstrings` (
...
--
-- Dumping data for table `svstrings`
--

LOCK TABLES `svstrings` WRITE;
/*!40000 ALTER TABLE `svstrings` DISABLE KEYS */;
INSERT INTO `svstrings` VALUES (1,'Bibeln','Det Gamle Testamente','Det Nye Testamente','Kapitel','Psalms','Poem','Sök');
/*!40000 ALTER TABLE `svstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:08:49
