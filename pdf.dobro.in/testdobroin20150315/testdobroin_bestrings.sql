...
--
-- Table structure for table `bestrings`
--

DROP TABLE IF EXISTS `bestrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bestrings` (
...
--
-- Dumping data for table `bestrings`
--

LOCK TABLES `bestrings` WRITE;
/*!40000 ALTER TABLE `bestrings` DISABLE KEYS */;
INSERT INTO `bestrings` VALUES (1,'Біблія','Стары Запавет','Новы Запавет','Кіраўнік','Псальма','верш','Пошук');
/*!40000 ALTER TABLE `bestrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:03:54
