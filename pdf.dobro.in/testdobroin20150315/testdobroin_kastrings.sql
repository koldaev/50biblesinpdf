...
--
-- Table structure for table `kastrings`
--

DROP TABLE IF EXISTS `kastrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kastrings` (
...
--
-- Dumping data for table `kastrings`
--

LOCK TABLES `kastrings` WRITE;
/*!40000 ALTER TABLE `kastrings` DISABLE KEYS */;
INSERT INTO `kastrings` VALUES (1,'ბიბლია','ძველი აღთქმა','ახალი აღთქმა','თავი','ფსალმუნი','პოემა','ძებნა');
/*!40000 ALTER TABLE `kastrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:03:22
