...
--
-- Table structure for table `japstrings`
--

DROP TABLE IF EXISTS `japstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `japstrings` (
...
--
-- Dumping data for table `japstrings`
--

LOCK TABLES `japstrings` WRITE;
/*!40000 ALTER TABLE `japstrings` DISABLE KEYS */;
INSERT INTO `japstrings` VALUES (1,'聖書','旧約聖書','新約聖書','章','賛美歌','詩','検索');
/*!40000 ALTER TABLE `japstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:04:07
