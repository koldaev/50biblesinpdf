...
--
-- Table structure for table `itstrings`
--

DROP TABLE IF EXISTS `itstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `itstrings` (
...
--
-- Dumping data for table `itstrings`
--

LOCK TABLES `itstrings` WRITE;
/*!40000 ALTER TABLE `itstrings` DISABLE KEYS */;
INSERT INTO `itstrings` VALUES (1,'Bibbia','Antico Testamento','Nuovo Testamento','Capitolo','Salmo','versetto','Trovare');
/*!40000 ALTER TABLE `itstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:21
