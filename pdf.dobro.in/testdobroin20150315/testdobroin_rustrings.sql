...
--
-- Table structure for table `rustrings`
--

DROP TABLE IF EXISTS `rustrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rustrings` (
...
--
-- Dumping data for table `rustrings`
--

LOCK TABLES `rustrings` WRITE;
/*!40000 ALTER TABLE `rustrings` DISABLE KEYS */;
INSERT INTO `rustrings` VALUES (1,'Библия','Ветхий Завет','Новый Завет','Глава','Псалом','стих','Найти');
/*!40000 ALTER TABLE `rustrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:59:17
