...
--
-- Table structure for table `lastrings`
--

DROP TABLE IF EXISTS `lastrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lastrings` (
...
--
-- Dumping data for table `lastrings`
--

LOCK TABLES `lastrings` WRITE;
/*!40000 ALTER TABLE `lastrings` DISABLE KEYS */;
INSERT INTO `lastrings` VALUES (1,'Biblia Sacra','Vetus Testamentum','Novum Testamentum','Capitulum','Psalmus','Poem','Invenies');
/*!40000 ALTER TABLE `lastrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:53:54
