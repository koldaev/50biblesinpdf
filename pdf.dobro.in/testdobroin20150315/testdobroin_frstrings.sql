...
--
-- Table structure for table `frstrings`
--

DROP TABLE IF EXISTS `frstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `frstrings` (
...
--
-- Dumping data for table `frstrings`
--

LOCK TABLES `frstrings` WRITE;
/*!40000 ALTER TABLE `frstrings` DISABLE KEYS */;
INSERT INTO `frstrings` VALUES (1,'La Bible','L\'Ancien Testament','Le Nouveau Testament','chapitre','Psaume','verset','Trouver');
/*!40000 ALTER TABLE `frstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:42
