...
--
-- Table structure for table `hebstrings`
--

DROP TABLE IF EXISTS `hebstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hebstrings` (
...
--
-- Dumping data for table `hebstrings`
--

LOCK TABLES `hebstrings` WRITE;
/*!40000 ALTER TABLE `hebstrings` DISABLE KEYS */;
INSERT INTO `hebstrings` VALUES (1,'הקודש במקרא','תנ \'ך','ברית חדשה','ראש','תהילים','פסוק','למצוא');
/*!40000 ALTER TABLE `hebstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:00:41
