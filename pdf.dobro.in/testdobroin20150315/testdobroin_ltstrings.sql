...
--
-- Table structure for table `ltstrings`
--

DROP TABLE IF EXISTS `ltstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ltstrings` (
...
--
-- Dumping data for table `ltstrings`
--

LOCK TABLES `ltstrings` WRITE;
/*!40000 ALTER TABLE `ltstrings` DISABLE KEYS */;
INSERT INTO `ltstrings` VALUES (1,'Biblija','Senasis Testamentas','Naujasis Testamentas','Skyrius','Psalmė','Eilėraštis','rasti');
/*!40000 ALTER TABLE `ltstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:57:06
