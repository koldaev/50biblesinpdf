...
--
-- Table structure for table `enstrings`
--

DROP TABLE IF EXISTS `enstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `enstrings` (
...
--
-- Dumping data for table `enstrings`
--

LOCK TABLES `enstrings` WRITE;
/*!40000 ALTER TABLE `enstrings` DISABLE KEYS */;
INSERT INTO `enstrings` VALUES (1,'Bible','Old Testament','New Testament','Chapter','Psalm','Poem','Find');
/*!40000 ALTER TABLE `enstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:56:24
