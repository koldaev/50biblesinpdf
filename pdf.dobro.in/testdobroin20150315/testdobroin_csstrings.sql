...
--
-- Table structure for table `csstrings`
--

DROP TABLE IF EXISTS `csstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `csstrings` (
...
--
-- Dumping data for table `csstrings`
--

LOCK TABLES `csstrings` WRITE;
/*!40000 ALTER TABLE `csstrings` DISABLE KEYS */;
INSERT INTO `csstrings` VALUES (1,'Bibli Svata','Starý zákon','Nový zákon','kapitola','Žalm','Báseň','Najít');
/*!40000 ALTER TABLE `csstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:18
