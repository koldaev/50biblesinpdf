...
--
-- Table structure for table `kostrings`
--

DROP TABLE IF EXISTS `kostrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kostrings` (
...
--
-- Dumping data for table `kostrings`
--

LOCK TABLES `kostrings` WRITE;
/*!40000 ALTER TABLE `kostrings` DISABLE KEYS */;
INSERT INTO `kostrings` VALUES (1,'성경','신약 성경','구약 성서','머리','시','시','발견');
/*!40000 ALTER TABLE `kostrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:18
