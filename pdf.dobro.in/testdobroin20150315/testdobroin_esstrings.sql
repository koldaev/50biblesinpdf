...
--
-- Table structure for table `esstrings`
--

DROP TABLE IF EXISTS `esstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `esstrings` (
...
--
-- Dumping data for table `esstrings`
--

LOCK TABLES `esstrings` WRITE;
/*!40000 ALTER TABLE `esstrings` DISABLE KEYS */;
INSERT INTO `esstrings` VALUES (1,'Biblia','Antiguo Testamento','Nuevo Testamento','capítulo','Salmo','verso','Buscar');
/*!40000 ALTER TABLE `esstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:06
