...
--
-- Table structure for table `amstrings`
--

DROP TABLE IF EXISTS `amstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amstrings` (
...
--
-- Dumping data for table `amstrings`
--

LOCK TABLES `amstrings` WRITE;
/*!40000 ALTER TABLE `amstrings` DISABLE KEYS */;
INSERT INTO `amstrings` VALUES (1,'መጽሐፍ ቅዱስ','አዲስ ኪዳን','ብሉይ ኪዳን','ምዕራፍ','መዝሙር','ስንኝ','ፈልግ');
/*!40000 ALTER TABLE `amstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:56:34
