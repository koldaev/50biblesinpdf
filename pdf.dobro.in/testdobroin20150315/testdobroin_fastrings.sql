...
--
-- Table structure for table `fastrings`
--

DROP TABLE IF EXISTS `fastrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fastrings` (
...
--
-- Dumping data for table `fastrings`
--

LOCK TABLES `fastrings` WRITE;
/*!40000 ALTER TABLE `fastrings` DISABLE KEYS */;
INSERT INTO `fastrings` VALUES (1,'کتاب مقدس','عهد قديم','عهد جديد','فصل','مزمور','شعر','جستجو');
/*!40000 ALTER TABLE `fastrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:05:02
