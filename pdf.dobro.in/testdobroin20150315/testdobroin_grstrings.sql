...
--
-- Table structure for table `grstrings`
--

DROP TABLE IF EXISTS `grstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grstrings` (
...
--
-- Dumping data for table `grstrings`
--

LOCK TABLES `grstrings` WRITE;
/*!40000 ALTER TABLE `grstrings` DISABLE KEYS */;
INSERT INTO `grstrings` VALUES (1,'Αγία Γραφή','Παλαιά Διαθήκη','Καινή Διαθήκη','Κεφάλι','Ψαλμός','στίχος','Βρίσκω');
/*!40000 ALTER TABLE `grstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:09
