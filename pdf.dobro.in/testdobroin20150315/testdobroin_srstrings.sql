...
--
-- Table structure for table `srstrings`
--

DROP TABLE IF EXISTS `srstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `srstrings` (
...
--
-- Dumping data for table `srstrings`
--

LOCK TABLES `srstrings` WRITE;
/*!40000 ALTER TABLE `srstrings` DISABLE KEYS */;
INSERT INTO `srstrings` VALUES (1,'Библија','Стари завет','Нови завет','Глава','Псалм','стих','Наћи');
/*!40000 ALTER TABLE `srstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:01:21
