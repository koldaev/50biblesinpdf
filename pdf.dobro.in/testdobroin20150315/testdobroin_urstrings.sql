...
--
-- Table structure for table `urstrings`
--

DROP TABLE IF EXISTS `urstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `urstrings` (
...
--
-- Dumping data for table `urstrings`
--

LOCK TABLES `urstrings` WRITE;
/*!40000 ALTER TABLE `urstrings` DISABLE KEYS */;
INSERT INTO `urstrings` VALUES (1,'انجیل مقدس','پرانے عہد نامہ','نئے عہد نامہ','باب','زبور','نظم','تلاش');
/*!40000 ALTER TABLE `urstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:58:58
