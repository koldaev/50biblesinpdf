...
--
-- Table structure for table `dustrings`
--

DROP TABLE IF EXISTS `dustrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dustrings` (
...
--
-- Dumping data for table `dustrings`
--

LOCK TABLES `dustrings` WRITE;
/*!40000 ALTER TABLE `dustrings` DISABLE KEYS */;
INSERT INTO `dustrings` VALUES (1,'Bijbel','Oude Testament','Nieuwe Testament','hoofdstuk','Psalm','Gedicht','Vind');
/*!40000 ALTER TABLE `dustrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:55:16
