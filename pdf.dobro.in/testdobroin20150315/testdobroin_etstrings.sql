...
--
-- Table structure for table `etstrings`
--

DROP TABLE IF EXISTS `etstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etstrings` (
...
--
-- Dumping data for table `etstrings`
--

LOCK TABLES `etstrings` WRITE;
/*!40000 ALTER TABLE `etstrings` DISABLE KEYS */;
INSERT INTO `etstrings` VALUES (1,'Piibel','Vana Testament','Uus testament','Peatükk','Psalm','Luuletus','Otsi');
/*!40000 ALTER TABLE `etstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:15
