...
--
-- Table structure for table `zhstrings`
--

DROP TABLE IF EXISTS `zhstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zhstrings` (
...
--
-- Dumping data for table `zhstrings`
--

LOCK TABLES `zhstrings` WRITE;
/*!40000 ALTER TABLE `zhstrings` DISABLE KEYS */;
INSERT INTO `zhstrings` VALUES (1,'圣经','旧约全书','新约全书','头','诗篇','诗','发现');
/*!40000 ALTER TABLE `zhstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 23:07:18
