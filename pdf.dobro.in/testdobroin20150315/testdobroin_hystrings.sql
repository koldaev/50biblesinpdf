...
--
-- Table structure for table `hystrings`
--

DROP TABLE IF EXISTS `hystrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hystrings` (
...
--
-- Dumping data for table `hystrings`
--

LOCK TABLES `hystrings` WRITE;
/*!40000 ALTER TABLE `hystrings` DISABLE KEYS */;
INSERT INTO `hystrings` VALUES (1,'ԱՍՏՈՒԱԾԱՇՈՒՆՉ','ՀԻՆ ԿՏԱԿԱՐԱՆ','ՆՈՐ ԿՏԱԿԱՐԱՆ','Գլուխ','Սաղմոս','Բանաստեղծություն','գտնել');
/*!40000 ALTER TABLE `hystrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:56:57
