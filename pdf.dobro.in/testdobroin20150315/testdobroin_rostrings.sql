...
--
-- Table structure for table `rostrings`
--

DROP TABLE IF EXISTS `rostrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rostrings` (
...
--
-- Dumping data for table `rostrings`
--

LOCK TABLES `rostrings` WRITE;
/*!40000 ALTER TABLE `rostrings` DISABLE KEYS */;
INSERT INTO `rostrings` VALUES (1,'Biblia','Vechiul Testament','Noul Testament','Capitolul','Psalm','Poezie','găsi');
/*!40000 ALTER TABLE `rostrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:54:12
