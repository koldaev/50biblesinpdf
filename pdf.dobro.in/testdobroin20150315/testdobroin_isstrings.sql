...
--
-- Table structure for table `isstrings`
--

DROP TABLE IF EXISTS `isstrings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `isstrings` (
...
--
-- Dumping data for table `isstrings`
--

LOCK TABLES `isstrings` WRITE;
/*!40000 ALTER TABLE `isstrings` DISABLE KEYS */;
INSERT INTO `isstrings` VALUES (1,'Biblían','Gamla Testamentið','Nýja Testamentið','Kafli','Sálmarnir','Ljóð','Leita');
/*!40000 ALTER TABLE `isstrings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-03-15 22:58:06
